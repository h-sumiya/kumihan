...
class UnicodeLineBreak {
  const UnicodeLineBreak(this.position, {this.required = false});
  ...
  UnicodeLineBreak? nextBreak() {
    ...
    while (_position < _text.length) {
      ...
      if (_currentClass == _bk || (_currentClass == _cr && _nextClass != _lf)) {
        ...
        return UnicodeLineBreak(_lastPosition, required: true);
      }
      ...
      if (mappedClass != null) {
        ...
        if (_nextClass == _cb) {
          return UnicodeLineBreak(_lastPosition);
        }
        continue;
      }
    ...
    if (_lastPosition < _text.length) {
      ...
      return UnicodeLineBreak(_text.length);
    }
